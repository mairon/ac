...
class ExchangesControllerTest < ActionController::TestCase
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post :create, exchange: { buy: @exchange.buy, company_id: @exchange.company_id, currency_id: @exchange.currency_id, date: @exchange.date, sale: @exchange.sale }
    end
  ...
  test "should update exchange" do
    patch :update, id: @exchange, exchange: { buy: @exchange.buy, company_id: @exchange.company_id, currency_id: @exchange.currency_id, date: @exchange.date, sale: @exchange.sale }
    assert_redirected_to exchange_path(assigns(:exchange))
  end
